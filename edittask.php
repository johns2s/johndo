...
<script>
  function alertDelete() {
    ...
    if (answer)
      window.location = "process.php?delete&template=<?php echo $taskID ?>&token=<?php echo $_SESSION['userToken'] ?>"
  }
</script>
  ...
  <div class = "logsignWrap">
    <form class = "item" action = "process.php" method = "POST">
      ...
      <div id = "repeatD" class = "sub">
        ...
        <input value = "<?php echo htmlentities($startDate); ?>" type = "date" class = "inputText" name = "startInput" placeholder = "Start date (MM/DD/YYYY)" required>
